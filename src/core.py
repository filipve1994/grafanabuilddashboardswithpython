...
class Row(object):
    ...
    :param panels: panels to show in row
    :param collapse: Is the row collapsed or not?
    :param editable: row is editable?
    :param height: what's the row's height?
    :param showTitle: title shown or not
    :param title: title of the row
    :param repeat: description to be added
    """
